...
class StockController {
    ...
    public function create() {
        ...
        if ($stock) {
            $alert = ($stock['quantity'] <= $stock['minimum_threshold'])
                ? 'WARNING: Stock quantity is at or below minimum threshold!' : null;
    ...
    public function show() {
        ...
        if ($stock['campus_id'] != Auth::campusId())
    ...
    public function delete() {
        ...
        if ($stock['campus_id'] != Auth::campusId())
            return Response::forbidden('You do not have permission to delete this stock item');
