...
class DepartmentController {
    ...
    public function listByCampus() {//departments of the campus of the user loggedin
    ...
    try {
        ...
        return Response::success('Departments retrieved', $departments, 200, [
            'count' => count($departments)
        ]);
    } catch (Exception $e) {
        return Response::serverError('Failed: ' . $e->getMessage());
    }
}
}
?>